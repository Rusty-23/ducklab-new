            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open("examination/editExamAttendance?id=$id", $form_attributs);
                        ?>
                            <?php $i = 1;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" name="action" required>
                                                ...
                                                if ($att == 'P') {
                                                    ?>
                                                    <option value="P" class="examAttendancePresent"><?php echo lang('exa_present'); ?></option>
                                                <?php } else { ?>
                                                    <option value="A" class="examAttendanceAbsent"><?php echo lang('exa_absent'); ?></option>
    <?php } ?>

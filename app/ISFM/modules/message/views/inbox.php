                                ...
                                foreach ($massage as $row) {
                                    ...
                                    <tr>
                                        ...
                                        ?>">
                                            ...
                                            <a class="btn btn-xs red" href="index.php/message/deleteInboxMassage?id=<?php echo $row['id']; ?>" onclick="javascript:return confirm('<?php echo lang('Send Your Massage.'); ?>')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>

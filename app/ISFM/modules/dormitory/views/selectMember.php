                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="dormitories" onchange="dormitorysRoomAmount(this.value)" class="form-control" name="dormitories" data-validation="required" data-validation-error-msg="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select id="ajaxResult" onchange="dormitorysRoomSeat(this.value)" name="room" class="form-control select2me" data-placeholder="<?php echo lang('select'); ?>"  data-validation="required" data-validation-error-msg="">
                                        </select>
                                    </div>
                                </div>
                            </div>
